...
class ProfileViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _showTerminalInfoEvent = LiveEvent<Unit>()
    val showTerminalInfoEvent: LiveData<Unit> = _showTerminalInfoEvent
    ...
    fun segueToTerminalInfo() {
        _showTerminalInfoEvent.postValue(Unit)
    }
